                                ...
                                <div className="overlay">
                                    ...
                                    <div className="content">
                                        ...
                                        <ul className="social">
                                            ...
                                            <li> <a href="javascript:;"><FaLinkedinIn /></a></li>
                                            <li> <a href="javascript:;"><FaGooglePlusG /></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="team5-card">
                                ...
                                <div className="team5-info">
                                    ...
                                    <ul className="team5-social">
                                        ...
                                        <li><a href="javascript:;"><FaTwitter /></a></li>
                                        <li><a href="javascript:;"><FaLinkedinIn /></a></li>
                                        <li><a href="javascript:;"><FaRss /></a></li>
                                    </ul>
                                </div>
                            </div>
                        </SwiperSlide>
                    ...
                    {team8Data.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="team-social">
                                <a href="javascript:;"><FaTwitter /></a>
                                <a href="javascript:;"><FaPinterestP /></a>
                                <a href="javascript:;"><FaFacebookF /></a>
                                <a href="javascript:;"><FaDribbble /></a>
                            </div>
                        </div>
                    ))}
                ...
                {team12Data.map((member, index) => (
                    <div className="team12-card-box" key={index}>
                        <div className="imgBox">
                            ...
                            {/* overlay */}
                            <div className={`team12overlay ${openIndex === index ? "show" : ""}`}>
                                <div className="social">
                                    <a href="#">
                                        <FaFacebookF />
                                    </a>
...
export { Teams2, Teams3, Team4, Team5, Team6, Team7, Team8, Team9, Team10, Team11, Team12, Team13 }
