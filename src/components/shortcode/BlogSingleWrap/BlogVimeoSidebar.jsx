      ...
      <div className="latestNewsCardInner">
        ...
        <div className="latestNewsCardImg VedioNewsCardWrap">
          {blogVimeoDetail.type === "video" ? (
            ...
            <a href={blogVimeoDetail.titleLink}>
              <img src={blogVimeoDetail.image} alt="blog" />
            </a>
          )}
...
export default BlogVimeoSidebarSection;
