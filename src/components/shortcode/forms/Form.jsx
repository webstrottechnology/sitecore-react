...
import { FaEnvelope, FaEnvelopeOpenText, FaFacebookF, FaGithub, FaGooglePlusG, FaHeadset, FaInstagram, FaLinkedinIn, FaTwitter } from 'react-icons/fa6';
import "./Form.scss";
        ...
        <div className="formFour-wrapper">
            <div className="formFour-container">
                ...
                <div className="social-buttons">
                    ...
                    <button className="social-btn"><img src={githubIcon} alt="" />GitHub</button>
                </div>
      ...
      <div className="container">
        <div className="contact-wrapper">
          ...
          <div className="contact-left">
            ...
            <p className='paraBox'>
             Curabitur gravida arcu ac tortor. Non consectetur a erat nam at. Facilisis magna etiam tempor orci eu lobortis elementum nibh tellus.
            </p>
            ...
            <div className="contact-card">
              ...
              <div className="info">
                <h3>Phone</h3>
                <p><a href="tel:+015656234100">+01 56562 34100</a></p>
                <p><a href="tel:+011234567890">+01 12345 67890</a></p>
              </div>
            </div>
            ...
            <div className="contact-card">
              ...
              <div className="info">
                <h3>Email</h3>
                <p><a href="mailto:sitecore@example.com">sitecore@example.com</a></p>
                <p><a href="mailto:sale@example.com">sale@example.com</a></p>
              </div>
            </div>
          </div>
...
export { FormTwo, FormThree, FormFour, FormFive, FormSeven, FormEight, FormNine, FormTen, FormEleven, FormTwelve,FormThirteen };
