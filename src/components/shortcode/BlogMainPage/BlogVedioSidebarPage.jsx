...
import BlogVedioSidebarSection from "../BlogSingleWrap/BlogVedioSidebar";
import { FormFourteen } from "../forms/Form";
import BlogLeftWrap from "../BlogLeftWrap/BlogLeftWrap";

const BlogVedioSidebarPage = () => {
  return (
...
export default BlogVedioSidebarPage;
